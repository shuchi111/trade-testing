...
at least one live-trade or past-AI fact, LESSONS FROM PAST MISTAKES when relevant, and the Claude \
Skills Pack connected consensus (score/gate + at least two screener names).

Context review (required short paragraph): confirm you checked wallet/holdings/trades/past AI \
decisions/backtests/lessons/skills-pack consensus and state the key constraint that shaped today's rating.
...
Be decisive only after the DB checklist and Claude Skills Pack observe step. Ground every \
conclusion in holdings, trade history, past decisions, screener consensus, and analyst evidence."""
