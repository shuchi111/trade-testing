...
class TradingAgentsGraph:
    ...
    def _create_tool_nodes(self) -> Dict[str, ToolNode]:
        return {
            "market": ToolNode(langchain_tools([get_stock_data, get_indicators])),
            ...
            "fundamentals": ToolNode(langchain_tools([
                get_fundamentals,
                get_balance_sheet,
                get_cashflow,
                get_income_statement,
    ...
    def propagate(self, company_name, trade_date, portfolio_context: str = "", asset_type: str = "equity"):
        ...
        init_agent_state = self.propagator.create_initial_state(
            company_name, trade_date, portfolio_context=portfolio_context, asset_type=asset_type
        )
