...
DEFAULT_CONFIG = {
    ...
    # LLM settings
    "llm_provider": _env_str("TRADINGAGENTS_LLM_PROVIDER", "anthropic"),
    ...
    "backend_url": _env_str("TRADINGAGENTS_BACKEND_URL", "https://api.z.ai/api/anthropic"),
    ...
    "anthropic_effort": os.getenv("TRADINGAGENTS_ANTHROPIC_EFFORT") or None,
